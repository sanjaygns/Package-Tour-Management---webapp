...
?>  <script type="text/javascript">
    if(!alert("Some error in database : please try again")) document.location = 'deletesubplaces.php';
...
<body>
    ...
    <form name="createpackage"  onSubmit = "return onclick()" action="deletesubplaceselect_exec.php" method="post">
