...
$qry= "select * from books where customer_id=$cid and cancel = '$one'";
$res = mysql_query($qry);
if(!$res)
{
...
if($r <1)
{
				...
				<p>
				  <script>
					if(!alert("no cancelling done!!")) document.location = "home.php";
				</script>
				  <?php
...
?>
				...
				<table width="300" height="255" border="1">
                  <tr>
                    <td class="style13"><span class="style10">Package Name  </span></td>
                    <td class="style13"><span class="style10"><?php echo $package['p_name']; ?></span></td>
                  </tr>
                  <tr>
                    <td class="style13"><span class="style10">Bill No <span class="style11"> .</span></span></td>
                    <td class="style13"><span class="style10"><?php echo $r['bill_no']; ?></span></td>
                  </tr>
                  <tr>
                    <td class="style13"><span class="style10">No of seats </span></td>
                    <td class="style13"><span class="style10"><?php echo $r['seats']; ?></span></td>
                  </tr>
                  <tr>
                    <td class="style13"><span class="style10">Amount Paid</span></td>
                    <td class="style13"><span class="style10"><?php echo $payment['amount']; ?></span></td>
                  </tr>
                  <tr>
                    <td class="style13"><span class="style10">Mode of payment</span></td>
                    <td class="style13"><span class="style10"><?php echo $payment['payment_mode']; ?></span></td>
                  </tr>
                  <tr>
                    <td class="style13"><span class="style10">Date of cancelling  </span></td>
                    <td class="style13"><span class="style10"><?php echo $r['booking_date']; ?></span></td>
                  </tr>
                </table>
				<p>_________________________________________________________________________________________________________________________________________________
                  <?php
