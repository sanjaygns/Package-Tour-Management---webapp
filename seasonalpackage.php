...
<title>National level Packages</title>
...
$qry= "select * from package where level='Seasonal Package'  and DATE(dep_date) > CURDATE()";
$res = mysql_query($qry);
if(!$res)
{
}
...
<div align="center"><span class="style10">List of Available Seasonal Package Names</span>
