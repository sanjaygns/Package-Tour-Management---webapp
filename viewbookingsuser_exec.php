...
if($r)
{
			...
			mysql_query($qry);
					 ...
					 $sub="Cancelling Information ";
	$email = $_SESSION['email'];
	$feedback = "SS package tours :"."you have cancelled  ".$seats." seats for package " .$pname." today and have received the receipt. Please come with the receipt within 3 days for Refund". "\nRegards,\nAdmin";
