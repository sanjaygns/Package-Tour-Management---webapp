...
var c=document.forms["createpackage"]["p_name"].value;
 ...
 if (c==null || c=="")
  ...
  var y=window.confirm("You are about to delete package in entered package name : Continue ");
if(y)
 return true;
else return false;
}
    ...
    <form name="createpackage"  onSubmit="return validateForm()" action="deletepackage_exec.php" method="post">
