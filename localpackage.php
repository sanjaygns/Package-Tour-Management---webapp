...
$qry= "select * from package where level='Local Package' and DATE(dep_date) > CURDATE()";
$res = mysql_query($qry);
if(!$res)
{
}
...
<div align="center"><span class="style10">List of Available Local Package Names</span>
