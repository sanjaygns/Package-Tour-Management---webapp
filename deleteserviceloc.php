...
if(mysql_num_rows($result1)<1)
{
  ...
  <script type="text/javascript">
    if(!(alert("couldn't find package name!!Try again!!"))) document.location = 'deleteservice.php';
...
{?>
<script type="text/javascript">
if(!alert("Currently Pacakge has empty location : please try again after adding location")) document.location = 'deleteservice.php';
...
?>
    ...
    <form name="createpackage"  action="deleteservicesubplace.php" method="post">
