...
var y=window.confirm("You are about to delete service in entered package name : Continue  ");
if(y)
 return true;
else return false;
    ...
    <form name="createpackage"  onSubmit="return validateForm()" action="deleteserviceloc.php" method="post">
